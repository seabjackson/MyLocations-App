...
// global function for handling CoreData Crashes
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func listenForFatalCoreDataNotifications() {
        NSNotificationCenter.defaultCenter().addObserverForName(MyManagedObjectContextSaveDidFailNotification, object: nil, queue: .mainQueue()) { notification in
